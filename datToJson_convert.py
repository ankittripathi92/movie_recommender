...
if __name__=="__main__":
    ...
    head_m, data_m = read_data('data/movies.dat')
    head_a, data_a = read_data('data/movie_actors.dat')
    head_d, data_d = read_data('data/movie_directors.dat')
    head_g, data_g = read_data('data/movie_genres.dat')
    head_r, data_r = read_data('data/user_ratedmovies.dat')
    
    dataFromFiles(head_m, data_m, head_a, data_a, head_d, data_d, head_g, data_g, head_r, data_r)
